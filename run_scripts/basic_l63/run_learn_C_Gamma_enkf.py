...
parser.add_argument("--project_name", type=str, default="mlda_l63_partialNoisyObs_enkf")
...
exp_dict = {
    ...
    "batch_length_T": [
        2
    ],  # length of a batch in model time units (e.g., for sample rate 1e-2, this is 200 samples)
    "burnin_frac": [
        0.75
    ],  # fraction of batch used for burn in (loss not computed on predictions made in this portion)
    "dyn_sys_name": ["Lorenz63"],
    "shuffle": ["once"],  # options are 'once', 'every_epoch', None
    "normalizer": [
        "unit_gaussian"
    ],  # options are 'inactive', 'unit_gaussian', 'min_max'
    "obs_noise_std": [1],
    # optimizer settings
    ...
    "use_nn": [True],
    "learn_h": [False],
    "learn_ObsCov": [True],  # Gamma
    "learn_StateCov": [True],  # C
    "num_hidden_layers": [1],
    "layer_width": [50],
    "activations": ["gelu"],
    "da_name": ["enkf"],  # ["3dvar", "enkf"],
    "N_ensemble": [30],
    # ODE settings
